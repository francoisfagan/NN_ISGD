...
#define __PYX_HAVE__cubic_root_closest_to_0
#define __PYX_HAVE_API__cubic_root_closest_to_0
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
#include <stdio.h>
...
/* Module declarations from 'cubic_root_closest_to_0' */
...
static PyObject *__pyx_f_23cubic_root_closest_to_0_get_roots(__Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "cubic_root_closest_to_0"
int __pyx_module_is_main_cubic_root_closest_to_0 = 0;

/* Implementation of 'cubic_root_closest_to_0' */
...
static const char __pyx_k_cube_solver[] = "cube_solver";
...
static const char __pyx_k_real_root_closest_to_zero[] = "real_root_closest_to_zero";
...
static PyObject *__pyx_n_s_cube_solver;
...
static PyObject *__pyx_n_s_real_root_closest_to_zero;
...
static PyObject *__pyx_pf_23cubic_root_closest_to_0_get_roots(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x); /* proto */
...
static PyObject *__pyx_pw_23cubic_root_closest_to_0_1get_roots(PyObject *__pyx_self, PyObject *__pyx_arg_x); /*proto*/
static PyObject *__pyx_f_23cubic_root_closest_to_0_get_roots(__Pyx_memviewslice __pyx_v_x, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_b;
  int __pyx_v_m;
  PyObject *__pyx_v_u_np = NULL;
 ...
 * 
 */
  __pyx_v_b = (__pyx_v_x.shape[1]);

  /* "cubic_root_closest_to_0.pyx":9
 *     # Calculate shape o
 *     cdef int b = x.shape[1]  # Mini-batch size
 *     cdef int m = x.shape[2]  # Output size from neural network layer             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_m = (__pyx_v_x.shape[2]);

  /* "cubic_root_closest_to_0.pyx":11
 *     cdef int m = x.shape[2]  # Output size from neural network layer
 * 
 *     u_np =  np.zeros([b, m], dtype='float32')             # <<<<<<<<<<<<<<
 *     cdef float [:,:] u = u_np
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_b); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_m); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 11, __pyx_L1_error)
  ...
  __Pyx_GOTREF(__pyx_t_4);
  if (PyDict_SetItem(__pyx_t_4, __pyx_n_s_dtype, __pyx_n_s_float32) < 0) __PYX_ERR(0, 11, __pyx_L1_error)
  __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_3, __pyx_t_4); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_v_u_np = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "cubic_root_closest_to_0.pyx":12
 * 
 *     u_np =  np.zeros([b, m], dtype='float32')
 *     cdef float [:,:] u = u_np             # <<<<<<<<<<<<<<
 * 
 *     for i in range(b):
 */
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_dsds_float(__pyx_v_u_np);
  if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 12, __pyx_L1_error)
  __pyx_v_u = __pyx_t_5;
  __pyx_t_5.memview = NULL;
  __pyx_t_5.data = NULL;

  /* "cubic_root_closest_to_0.pyx":14
 *     cdef float [:,:] u = u_np
 * 
 *     for i in range(b):             # <<<<<<<<<<<<<<
 *         for j in range(m):
 ...
 */
  ...
  for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
    ...
    /* "cubic_root_closest_to_0.pyx":15
 * 
 *     for i in range(b):
 *         for j in range(m):             # <<<<<<<<<<<<<<
 *             u[i, j] = cube_solver.real_root_closest_to_zero(x[:, i, j])
 ...
 */
    ...
    for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
      ...
      /* "cubic_root_closest_to_0.pyx":16
 *     for i in range(b):
 *         for j in range(m):
 *             u[i, j] = cube_solver.real_root_closest_to_zero(x[:, i, j])             # <<<<<<<<<<<<<<
 * 
 *     return u_np
 */
      __pyx_t_4 = __Pyx_GetModuleGlobalName(__pyx_n_s_cube_solver); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 16, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_real_root_closest_to_zero); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 16, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __pyx_t_10.data = __pyx_v_x.data;
      __pyx_t_10.memview = __pyx_v_x.memview;
      __PYX_INC_MEMVIEW(&__pyx_t_10, 0);
      __pyx_t_10.shape[0] = __pyx_v_x.shape[0];
__pyx_t_10.strides[0] = __pyx_v_x.strides[0];
...
__pyx_t_4 = __pyx_memoryview_fromslice(__pyx_t_10, 1, (PyObject *(*)(char *)) __pyx_memview_get_float, (int (*)(char *, PyObject *)) __pyx_memview_set_float, 0);; if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 16, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      ...
      if (!__pyx_t_2) {
        ...
        #endif
        {
          __pyx_t_11 = PyTuple_New(1+1); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 16, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_11);
          __Pyx_GIVEREF(__pyx_t_2); PyTuple_SET_ITEM(__pyx_t_11, 0, __pyx_t_2); __pyx_t_2 = NULL;
          __Pyx_GIVEREF(__pyx_t_4);
          PyTuple_SET_ITEM(__pyx_t_11, 0+1, __pyx_t_4);
          __pyx_t_4 = 0;
          __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_11, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 16, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_1);
          __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
        }
      }
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __pyx_t_12 = __pyx_PyFloat_AsFloat(__pyx_t_1); if (unlikely((__pyx_t_12 == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 16, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      ...
      } else if (unlikely(__pyx_t_13 >= __pyx_v_u.shape[0])) __pyx_t_15 = 0;
      if (__pyx_t_14 < 0) {
        __pyx_t_14 += __pyx_v_u.shape[1];
        if (unlikely(__pyx_t_14 < 0)) __pyx_t_15 = 1;
      } else if (unlikely(__pyx_t_14 >= __pyx_v_u.shape[1])) __pyx_t_15 = 1;
      if (unlikely(__pyx_t_15 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_15);
        __PYX_ERR(0, 16, __pyx_L1_error)
      }
      *((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_u.data + __pyx_t_13 * __pyx_v_u.strides[0]) ) + __pyx_t_14 * __pyx_v_u.strides[1]) )) = __pyx_t_12;
    }
  }

  /* "cubic_root_closest_to_0.pyx":18
 *             u[i, j] = cube_solver.real_root_closest_to_zero(x[:, i, j])
 * 
 *     return u_np             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __Pyx_INCREF(__pyx_v_u_np);
  __pyx_r = __pyx_v_u_np;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("cubic_root_closest_to_0.get_roots", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_u_np);
...
/* Python wrapper */
static PyObject *__pyx_pw_23cubic_root_closest_to_0_1get_roots(PyObject *__pyx_self, PyObject *__pyx_arg_x); /*proto*/
static PyObject *__pyx_pw_23cubic_root_closest_to_0_1get_roots(PyObject *__pyx_self, PyObject *__pyx_arg_x) {
  __Pyx_memviewslice __pyx_v_x = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("get_roots (wrapper)", 0);
  assert(__pyx_arg_x); {
    __pyx_v_x = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_float(__pyx_arg_x); if (unlikely(!__pyx_v_x.memview)) __PYX_ERR(0, 5, __pyx_L3_error)
  }
  ...
  __pyx_r = __pyx_pf_23cubic_root_closest_to_0_get_roots(__pyx_self, __pyx_v_x);
...
static PyObject *__pyx_pf_23cubic_root_closest_to_0_get_roots(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("get_roots", 0);
  ...
  __pyx_t_1 = __pyx_f_23cubic_root_closest_to_0_get_roots(__pyx_v_x, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "cubic_root_closest_to_0.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "cubic_root_closest_to_0.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "cubic_root_closest_to_0.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "cubic_root_closest_to_0._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"get_roots", (PyCFunction)__pyx_pw_23cubic_root_closest_to_0_1get_roots, METH_O, 0},
  {0, 0, 0, 0}
};
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_cube_solver, __pyx_k_cube_solver, sizeof(__pyx_k_cube_solver), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_real_root_closest_to_zero, __pyx_k_real_root_closest_to_zero, sizeof(__pyx_k_real_root_closest_to_zero), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initcubic_root_closest_to_0(void); /*proto*/
PyMODINIT_FUNC initcubic_root_closest_to_0(void)
#else
PyMODINIT_FUNC PyInit_cubic_root_closest_to_0(void); /*proto*/
PyMODINIT_FUNC PyInit_cubic_root_closest_to_0(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_cubic_root_closest_to_0(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cubic_root_closest_to_0", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_cubic_root_closest_to_0) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "cubic_root_closest_to_0")) {
      if (unlikely(PyDict_SetItemString(modules, "cubic_root_closest_to_0", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  /* "cubic_root_closest_to_0.pyx":2
 * import numpy as np
 * import cube_solver             # <<<<<<<<<<<<<<
 * 
 * 
 */
  __pyx_t_1 = __Pyx_Import(__pyx_n_s_cube_solver, 0, -1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_cube_solver, __pyx_t_1) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init cubic_root_closest_to_0", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cubic_root_closest_to_0");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
